...
# validation/scd2/prepare_scd2_supplier_fixture.py
...
print("Cenários:")
print("  - Type 1 puro: nomefantasia/status/permitenfsempedido/id_tipoempresa")
print("  - telefone permanece na Bronze da fixture para provar que NÃO vaza para a Silver")
